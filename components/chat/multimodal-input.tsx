  ...
  const handleSlashSelect = (cmd: SlashCommand) => {
    ...
    switch (cmd.action) {
      ...
      case "clear":
        ...
        break;
      case "rename":
        toast("Puedes renombrar el chat desde el menú lateral.");
        break;
      case "model": {
      ...
      case "delete":
        ...
        break;
      case "purge":
        toast("¿Eliminar todos los chats?", {
          action: {
            label: "Eliminar todo",
            onClick: () => {
              ...
              router.push("/");
              toast.success("Todos los chats eliminados");
            },
          },
        });
        break;
    ...
    <div className={cn("relative flex w-full flex-col gap-4", className)}>
      ...
      >
        ...
        <PromptInputTextarea
          ...
          placeholder={
            editingMessage ? "Editando mensaje..." : "Escribe tu pregunta..."
          }
          ref={textareaRef}
          value={input}
        />
